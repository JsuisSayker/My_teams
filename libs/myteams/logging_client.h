...
** the team, that have the channel, that have the thread, that
** got the new reply
*/
...
** When you log out (/logout) you should also receive
** the event before quitting.
...
/**
** @brief Must be called when the current logged user
...
** ex: asking the teams you are subscribed to or the available teams
** in a domain
